...
<div class="p-4 sm:ml-64 mt-20 flex justify-center">
    <form action="{{ route('upload.courses') }}" method="post" enctype="multipart/form-data"
        class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 sm:w-2/5 w-full">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="courseUnit" name="courseUnit"
        ...
        <div class="flex justify-center">
            <button type="submit"
                class="bg-gray-700 text-white hover:bg-red-700 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Submit
            </button>
        </div>
